...
-- set dap keymaps
set_keymap("n", "<F2>", "<cmd>lua require('dap').set_breakpoint(vim.fn.input('Breakpoint condition: '))<CR>", "Breakpoint Condition")
...
set_keymap("n", "<F6>", "<cmd>lua require('dap').run_to_cursor()<CR>", "Run to Cursor")
set_keymap("n", "<S-F6>", "<cmd>lua require('dap').goto_()<CR>", "Go to Line (No Execute)")
